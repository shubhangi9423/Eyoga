...
$qry=mysqli_query($con,"select * from tblmat   order by mtid desc limit 3");
  ...
  <img src="../admin/uploads/cloth/<?=$r["mimage"]?>" height="200px" width="200px">
   </td>
</Tr>
  <tr>
...
while($r=mysqli_fetch_assoc($qry))
{
  ...
  <img src=" ../admin/<?=$r["mimage"]?>" height="200px" width="200px">
   </td>
  <tr>
   ...
   <td>
	 ...
	 <a href="dispimg.php?id=<?=$r["mtid"]?>"  class="fancybox fancybox.iframe"><input type="submit" class="btn btn-warning" col-span=2 align="center" value="View More" /></a>
