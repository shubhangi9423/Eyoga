...
<?php
     $did = $_GET['id']; 
	 $result = mysql_query("select * from tblcloth where clid =".$_GET['id']);
	...
	<div class="x_content">
	 ...
	 <div class="item form-group">
      ...
      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Add Drink Type<span class="required"></span>
       ...
       <input id="name" value="<?=$row["cloth"]?>"  class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" required="required" type="text">
       </div>
	   </div>
	   ...
	   <div class="item form-group">
			...
			<div class="col-md-3 col-sm-3 col-xs-6">
       <input id="name" disabled="disabled" value="<?=$row["cimage"]?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="m1" required="required" type="text">
       </div>
	   
          <div class="col-md-3 col-sm-3 col-xs-6">
		  <?php
		  $qry=mysql_query("select * from tblcloth ");
		  ?>
			...
			while($r1=mysql_fetch_array($qry))
            {
             ...
             ?>
             <option value="<?=$r1['cimage']?>"><?=$r1["cimage"]?></option>
	 ...
	 <div class="item form-group">
       ...
       <div class="col-md-3 col-sm-3 col-xs-6">
       <input id="name"  value="<?=$row["cprice"]?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="price" required="required" type="text">
       </div>
	   </div>
	    <div class="item form-group">
       ...
       <div class="col-md-3 col-sm-3 col-xs-6">
       <input id="name" value="<?=$row["cdprice"]?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="discountprice" required="required" type="text">
       </div>
	   </div>
	    <div class="item form-group">
       ...
       <div class="col-md-3 col-sm-3 col-xs-6">
       <input id="name" value="<?=$row["cquantity"]?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="qty" required="required" type="text">
       </div>
	 </div>
...
$result="UPDATE tblcloth
          SET male='$male',
		      female='$female',
		      cloth='$name',
			  cimage='$m1',
		      cprice='$price',
			  cdprice='$discountprice',
			  cquantity='$qty'
			  WHERE 
...
{
extract($_POST);
$result="delete from  tblcloth  where clid=".$_GET["id"];
mysql_query($result);
}
?>
