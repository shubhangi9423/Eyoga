...
<div  role="main">
	...
	<div class="x_content">
	 <form action="mupload.php" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data" >
	
      <div class="item form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Add Mat Type <span class="required"></span>
       </label>
	...
	<div class="col-md-3 col-sm-3 col-xs-12" style="margin-left:60%">
	 ...
	 <div class="item form-group">
      ...
      <input type="submit" class="btn btn-primary" value="Submit" >
	   ...
	   <a href="mgrid.php"> <input type="submit"  class="btn btn-success" name="btnedit" value="Edit" style="margin-left:27%"> </a>
	   </div>
       </div>
       </div>
	    <?php
