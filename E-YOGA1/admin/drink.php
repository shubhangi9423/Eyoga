...
<div  role="main">
	...
	<div class="x_content">
	 <form action="dupload.php" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data" >
	...
	<div class="col-md-3 col-sm-3 col-xs-12" style="margin-left:60%">
	 ...
	 <div class="item form-group">
      ...
      <input type="submit" class="btn btn-primary" value="Submit" >
	   ...
	   <a href="dgrid.php"> <input type="submit"  class="btn btn-success" name="btnedit" value="Edit" style="margin-left:27%"> </a>
	   </div>
       </div>
       </div>
	    <?php
